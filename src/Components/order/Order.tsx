    ...
    return (
        <div className='order_section'>
            <div className='container mx-auto'>
                <div className="row">
                    <div className="col-lg-6 col-md-3 col-12 d-none d-lg-block">
                        <img src={elephant} />
                    </div>
                    <div className="col-lg-6 col-md-3 col-12 marginbox">
                        ...
                        <div className="d-lg-flex">
                            ...
                            <div className="col-lg-3">
                                <a href="" className='touch_btn  col-12 mt-2 mt-lg-0'>Get In Touch</a>
                            </div>
                        </div>
                    </div>
                </div>
